                ...
                <div className="Process">
                    <div className="Process__divs">
                     ...
                     <div className="Process__divs">
                        ...
                        <p>Доступ к мастер- <br/>классам открыт 24/7. Вы <br/>сами решаете, когда у <br/>вас следующий урок</p>
                    </div>
                    <div className="Process__divs">
                        <h2>3</h2> <br/>
                    ...
                    <div className="Process__divs">
                        <h2>4</h2> <br/>
                        <span>Доступ</span>
                        <p>Мы предоставляем вам <br/>бессрочный доступ к <br/>материалам любого <br/>оплаченного мастер-класса</p>
                    </div>
                </div>
            </div>
        </div>
