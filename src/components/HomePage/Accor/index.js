        ...
        <div className="accor">
          ...
          <div className="accor__all">
            <div className="accor__all-item">
              {data.map((cold, i) => (
                <div className="accor__all-item-cold">
                  <div
                    className="accor__all-item-title"
                    onClick={() => toggle(i)}
                  >
                    <h2>{cold.Question}</h2>
                    <span>
                  ...
                  <div
                    className={
                      selected === i
                        ? "accor__all-item-content::shadow"
                        : "accor__all-item-content"
                    }
                  >
                    {cold.answer}
                  </div>
...
const data = [
  ...
  },
  {
    ...
    answer:
      "С++ разработчику необходимо знать устройство компьютера, основные операторы языка,\n" +
  ...
  },
  {
    ...
    answer:
      "Обновление смартфона не только помогает оптимизировать\n" +
