                ...
                <div className="faq">
                    ...
                    <div className="faq--we">
                        ...
                        <div onClick={() => {
                            ...
                            setQuestion2(false)
                            setQuestion3(false)
                        }} style={{height: question1 ? "210px" : ""}} className="faq--we__left">
...
>>>>>>>> 0494439beb1a0d451e7a07743d97f09fb21f7f7e:src/components/Main/Accordion/index.js
                        ...
                        }} style={{height: question2 ? "210px" : ""}} className="faq--we__left">
                            <div className="faq--we__left--title">
                                <h3 className="faq--we__left--title__accord">
                                ...
                                <button className="faq--we__left--title__accord--btn">
                                    {
                                        question2 ? <span className="faq--we__left--title__accord--btn__icon">
                                <BsChevronUp/>
                            </span> : <span className="faq--we__left--title__accord--btn__down">
                                <BsChevronDown/>
                            </span>
                        ...
                        }} style={{height: question3 ? "210px" : ""}} className="faq--we__left">
                            <div className="faq--we__left--title">
                                <h3 className="faq--we__left--title__accord">
                                ...
                                <button className="faq--we__left--title__accord--btn">
                                    {
                                        question3 ? <span className="faq--we__left--title__accord--btn__icon">
                                <BsChevronUp/>
                            </span> : <span className="faq--we__left--title__accord--btn__down">
                                <BsChevronDown/>
                            </span>
